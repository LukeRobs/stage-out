// ==UserScript==
// @name         Queue List - SeaTalk Hourly Report · Recife 04
// @namespace    spx-express
// @version      1.0
// @updateURL    https://raw.githubusercontent.com/LukeRobs/stage-out/main/queue_list_report_recife04.user.js
// @downloadURL  https://raw.githubusercontent.com/LukeRobs/stage-out/main/queue_list_report_recife04.user.js
// @description  Captura screenshot do dashboard Queue List e envia ao SeaTalk a cada hora cheia
// @author       SPX Express
// @match        https://stage-out.onrender.com/queue_list_recife04.html
...
(function () {
  ...
  function buildReportText(kpis) {
    ...
    return [
      `Report - Queue List · Inbound · Recife 04 (${data})`,
      `Hora: ${hora}`,
      ``,
      ...
      ``,
      `Link para acompanhamento: https://stage-out.onrender.com/queue_list_recife04.html`,
    ].join('\n');
  }
  ...
  function postReport(image, text) {
    return new Promise((resolve, reject) => {
      GM_xmlhttpRequest({
        ...
        data:    JSON.stringify({ image, text, station_id: STATION_ID }),
        timeout: 60000,
        onload: r => {
  ...
  console.log('[Queue Report] ✅ v1.0 Recife04 — Bot API direto, a cada hora cheia (:00)');
})();
